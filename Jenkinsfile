pipeline {
	...
	environment {
		appIP="34.140.28.253";
		gitRepo="https://github.com/AlanTowleGH/SpringBoot-Jenkins.git";
		repoName="SpringBoot-Jenkins";
		databaseIP="35.195.232.17";
	}
	stages{
...
spring.datasource.password=root' > ./src/main/resources/application-dev.properties
			mvn clean package
			'''
			}
		}
